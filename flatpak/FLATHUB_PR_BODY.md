<!--
  Flathub submission PR body for BigBox (io.github.podheitor.bigbox).
  Copy the block between the BEGIN/END markers below into the GitHub
  PR description when opening the PR against flathub/flathub:new-pr.
