...
arch=('x86_64')
url="https://github.com/podheitor/BigBox-Tauri"
license=('GPL-3.0-or-later')
depends=('webkit2gtk-4.1' 'gtk3' 'libayatana-appindicator')
makedepends=('rust' 'cargo')
provides=('bigbox')
conflicts=('bigbox')
source=("${pkgname}-${pkgver}.tar.gz::https://github.com/podheitor/BigBox-Tauri/archive/refs/tags/v${pkgver}.tar.gz")
sha256sums=('SKIP')

build() {
    cd "BigBox-Tauri-${pkgver}"
